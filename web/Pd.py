...
class PdReceive(asynchat.async_chat):
	def __init__(self, parent, localaddr=("127.0.0.1", 3010), map=None):
		self._parent = parent
		asynchat.async_chat.__init__(self, map=map)
		self._ibuffer = ""
		self.set_terminator(";\n")
...
class Pd:
	...
	"""
	errorCallbacks = {}
	def __init__(self, port=3000, nogui=True, open="python-interface-help.pd", cmd=None, path=["patches"], extra=None, stderr=True):
		"""
